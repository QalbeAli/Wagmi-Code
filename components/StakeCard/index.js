...
export function StakeCard({ card }) {
    ...
    const progress = lockedAmount && totalStake ? (Number(lockedAmount) / Number(totalStake)) * 100 : 0;
        ...
        <>
            ...
            <div className={cardStyles.stakingcards}>
                <div className={cardStyles.stakingCardInner}>
                    ...
                    <h5 className={cardStyles.head5}>{cardText}
                        {
                            ISLOCKED &&
                    ...
                    <div className="card-body">
                        ...
                        <div style={{ marginTop: "20px", marginLeft: "14px" }}>
                            ...
                            <p style={{ color: "white", fontSize: "12px" }}>{Number(lockedAmount).toLocaleString()} $GEMS <span style={{ color: "#878787", fontSize: "12px" }}>of {Number(totalStake).toLocaleString()} $GEMS</span></p>
                                ...
                                <div className='row'>
                                    {
                                        ...
                                        <div className='col-5 col-sm-5 col-lg-5'>
                                            <p
                                                style={{
                                                    fontSize: "17px", color: "white", paddingBottom: '0',
                                                    marginBottom: 0
                                                }}
                                            >
                                                {depositTime} UTC
                            ...
                            <div className='row'>
                                <div className='col-sm-6 col-6'>
                                    ...
                                    <h5 style={{ color: "white", fontSize: "18px" }}>{stakedAmount} $GEMS</h5>
                                </div>
                                <div className='col-sm-6 col-6'>
                                    <p style={{ color: "#878787", fontSize: "12px" }}>Rewards</p>
                                    <h5 style={{ color: "#815efa", fontSize: "18px" }}>{reward} $GEMS</h5>
                                </div>
                            </div>
                            <br></br>
                            {
                            ...
                            <>
                                {
                                    ...
                                    <>
                                        {
                                            ISLOCKED ? <button className={cardStyles.btn11}>Locked-Up</button> :
                                                <>
                                                    {
                                                        !userStaked ?
                                                            <button
